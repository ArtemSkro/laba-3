    ...
    public MainFrame(Double[] coefficients) {
        ...
        Action aboutInfoAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Скробатун Артём, 10 группа", "О программе",
        ...
        buttonCalc.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    data = new GornerTableMode(from, to, step, MainFrame.this.coefficients);
